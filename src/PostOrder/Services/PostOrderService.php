...
class PostOrderService extends \DTS\eBaySDK\PostOrder\Services\PostOrderBaseService
{
     ...
     */
    public function submitCancellationRequest(\DTS\eBaySDK\PostOrder\Types\SubmitCancellationRequestRestRequest $request, array $digestHeaders = [])
    {
        return $this->submitCancellationRequestAsync($request, $digestHeaders)->wait();
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitCancellationRequestAsync(\DTS\eBaySDK\PostOrder\Types\SubmitCancellationRequestRestRequest $request, array $digestHeaders = [])
    {
        return $this->callOperationAsync('SubmitCancellationRequest', $request, $digestHeaders);
    }
     ...
     */
    public function issueReturnRefund(\DTS\eBaySDK\PostOrder\Types\IssueReturnRefundRestRequest $request, array $extraDigestHeaders = [])
    {
        return $this->issueReturnRefundAsync($request, $extraDigestHeaders)->wait();
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function issueReturnRefundAsync(\DTS\eBaySDK\PostOrder\Types\IssueReturnRefundRestRequest $request, array $extraDigestHeaders = [])
    {
        return $this->callOperationAsync('IssueReturnRefund', $request, $extraDigestHeaders);
    }
